...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      ...
      <hr />
      <form action="<?= base_url(); ?>administrator/edit_username_users_admin" method="post">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      ...
      <form action="<?= base_url(); ?>administrator/edit_pass_users_admin" method="post">
        <div class="form-group">
