                    ...
                    <form action="<?= base_url(); ?>administrator/setting/sosmed/add" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon" required autocomplete="off">
														<small class="text-muted">Buka link ini <a href="https://fontawesome.com/icons" target="_blank">fontawesome</a> lalu cari nama sosmed. Misal icon untuk Facebook adalah fab fa-facebook-f</small>
                        </div>
                        <div class="form-group">
